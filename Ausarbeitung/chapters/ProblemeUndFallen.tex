...
In diesen ADLs lässt sich gut die Geschäftslogik abbilden. Viele dieser ADLs ermöglichen es, ein Modell der Komponentenstruktur und des Verhaltens zu erstellen und  dienen als Grundlage für die Integrationstests.\cite{SAE}
\paragraph{Problem}
...
\paragraph{Folgen}
Die Software wird zu komplex und zu teuer. Außerdem ist es möglich, dass sollten Änderungen in anderen Dimensionen vonnöten sein, diese sogar schwieriger werden als wenn die Software mit einer einfacheren Architektur implementiert worden wäre.
