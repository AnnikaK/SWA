\chapter{Motivation}
Softwaresysteme sind häufig langlebig. Im laufe der Zeit im Lebenszyklus der Software kommen typischerweise Änderungen zur Software.\\
...
Im Buch "Software Systems Architecture"(\cite{SSA:12},S.546) von Nick Rozanski und Eoin Woods wurden folgende Arten als Dimensionen von Änderunge (Dimensions of Change) herausgearbeitet:
...
In verschiedenen Agilen Softwareentwicklungsmethoden wird aufgrund der Wichtigkeit des Produktmanagements diese Rolle direkt in der Entwicklungsmethode eingebaut. So gibt es bei z.B. Scrum die Rolle des Product Owners, welche genau diese Aufgaben hat.\\
...
- Änderungen von Vorschriften und Gesetzten, besonders wichtig wenn diese strenger werden wie die Datenschutzgrundverordnung oder die EPrivacy verordnung\\
...
Wie bereits in \ref{komplex} besprochen, ist Eine Architektur, welche die Evolution unterstützt, ist häufig komplexer, als solche die nicht. Zudem sind die Kosten und die Entwicklungszeit für die erste Version meist teurer. Es kann sogar sein das diese erhöhte Komplexität bestimmte Änderungen erschwert.
(\cite{SSA:12},S.548) 
...
Selbst kleinste Änderungen, wie z.B. Bugfixes, können durchaus gravierende negative Auswirkungen auf ein eingesetzten System haben. Daher wird eine Menge von Prozessen und Technologien benötigt, die Sicherstellt, dass Änderungen zuverlässig sind. Solche werden in \ref{zuverl} besprochen.\\
 (\cite{SSA:12},S.548) 
